...
namespace HutongGames.PlayMaker.Actions
{
    ...
    public class DOTweenTransformLocalPath : FsmStateAction
    {
        ...
        public override void OnEnter()
        {
            ...
            {
                case LookAt.nothing:
                    tween = trn.DOLocalPath(waypoints, duration.Value, pathType, pathMode, resolution.Value, gizmoColor.Value)
            ...
            tween.Play();
            if (debugThis.Value) State.Debug("DOTween Transform Local PathObject");
